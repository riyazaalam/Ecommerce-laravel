                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                            ...
                            <ul class="list-unstyled navbar__list">
                                ...
                                <li class="@yield('category_select')">
                                    <a href="{{url('admin/category')}}">
                                        <i class="fas fa-list"></i>Categry</a>
                                </li>
                        ...
                        <li class="@yield('trash_select')">
                                    <a href="{{url('admin/coupan/trash')}}">
                                        <i class="fas fa-sync-alt"></i>Trash Data</a>
                                </li>
                                            ...
                                            <div class="account-dropdown js-dropdown">
                                                ...
                                                <div class="account-dropdown__body">
                                                    <div class="account-dropdown__item">
                                                        ...
                                                        <a href="{{url('admin/layout/regupdate/'.Session::get('ADMIN_ID'))}}">
                                                ...
                                                <div class="account-dropdown__footer">
                                                    <a href="{{url('admin/category/logout')}}">
